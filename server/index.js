...
if (process.env.NODE_ENV === "production") {
  app.use(express.static("portofolio/build"));
  app.get("*", (req, res) =>
    res.sendFile(path.resolve("portofolio", "build", "index.html"))
  );
}
...
router.post("/contact", (req, res) => {
  ...
  const mailToCeo = {
    from: "portofolio",
    to: "bazilucm@gmail.com",
    subject: "Contact",
    html: ` <p style="font-size:16px">${name}</p>
    <p style="font-size:16px">${email}</p>
    <p style="font-size:16px">${phone}</p>
    <p style="font-size:16px">${message}</p>
   `,
  };
  transporter.sendMail(mailToCeo, (error) => {
    if (error) {
      res.send(error);
    }
  ...
  const mailToUser = {
    from: "Baziluc Marian",
    to: email,
    subject: "I reveived your message!",
    html: `
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          <tr>
                                            ...
                                            >
                                              Thanks for sending me a message! I’ll
                                    ...
                                    <td align="center" style="padding:40px 10px">
                                      ...
                                      >
                                        ...
                                        <tr>
                                          ...
                                          >
                                            <a
                                              href="mailto:bazilucm@gmail.com"
                                              style="color:#ffffff; text-decoration:none!important"
                                              >bazilucm@gmail.com</a
                                            >
                                          </td>
                                        </tr>
                                      </table>
  ...
  transporter.sendMail(mailToUser, (error) => {
    if (error) {
      res.send(error);
    }
    res.status(200).send({ message: "Mail send to User" });
  });
});
